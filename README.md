...
- 🎨 캐릭터·배경 그래픽을 **코드로 생성**하거나 라이선스 안전한 외부 에셋을 받아들이고 (저작권 안전)
- 🔊 효과음·배경음악을 **합성**하고
- 📱 **모바일 터치 컨트롤**까지 붙여서
...
**🎨 그래픽을 코드로 생성**
픽셀아트(`PixelForge`)와 미려한 벡터(`VectorForge`) 모두 코드로 생성하며, 라이선스 안전한 외부 에셋도 함께 쓸 수 있습니다.

**🔊 8비트 너머 사운드**
칩튠부터 신스웨이브·앰비언트·적응형 음악까지 코드 합성. 오디오 파일 0개.

**⚖️ 저작권 안전 (IP-safe)**
라이선스 안전한 외부 에셋(CC0·표기형·허용 라이선스) 또는 절차적 생성. 닌텐도 등 상용 IP의 에셋·이름·시그니처는 쓰지 않습니다.
...
게임당 한 가지 렌더 스타일을 택합니다 — 둘 다 코드 생성(CC0/IP-safe)이며, 라이선스 안전한 외부 에셋도 함께 쓸 수 있습니다.
...
├── assets-library/ · assets.json                      # 이전 사용 스프라이트 · 라이선스 게이트
...
- **에셋**: 라이선스 안전한 외부 에셋(CC0·표기형·허용 라이선스) 또는 절차적 생성 (상용 IP 미사용)
