...
// 무의존성: Node 빌트인(fs/path/url)만 사용. npm install 불요. sprite-picker/catalog/analyze-pack.mjs 컨벤션 준수.
//
...
//   node skills/item-architect/tools/lint-items.mjs --file games/<slug>/items.json --json
//   node skills/item-architect/tools/lint-items.mjs <file> --strict   (warn 도 실패로)
//
