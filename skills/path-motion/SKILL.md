...
- 경로·커브 전반: [`reference/phaser/curves-and-paths.md`](../web-game-builder/reference/phaser/curves-and-paths.md)
- PathFollower 트윈 속성: [`reference/phaser/tweens.md`](../web-game-builder/reference/phaser/tweens.md)
- Graphics 렌더링: [`reference/phaser/graphics-and-shapes.md`](../web-game-builder/reference/phaser/graphics-and-shapes.md)
- 전체 레퍼런스 색인: [`reference/phaser/INDEX.md`](../web-game-builder/reference/phaser/INDEX.md)
...
- 관련 스킬: [juice-fx](../juice-fx/SKILL.md)(히트 이펙트), web-game-builder(전체 워크플로).
