...
> - **무엇을 만들지(게임 자체):** 재미요소 `FE-*` — [game-dna/fun-elements.md](../wgf-web-game-builder/reference/game-dna/fun-elements.md)
...
>
> **"맵" ≠ 타일맵.** [`level-designer`](../wgf-level-designer/SKILL.md)의 "맵"은 *레벨 내부 지형(타일맵·
...
- **맵 화면·내비게이션:** [build-patterns.md](./reference/map-design/build-patterns.md)의 패턴으로 Title↔Game 사이에
  **Map 씬**(saga 스크롤/노드 그래프/액트맵)을 빌드한다. 연출·HUD가 무거우면 [`game-ui-hud`](../wgf-game-ui-hud/SKILL.md),
  타일/배치 빌드는 [`level-designer`](../wgf-level-designer/SKILL.md)로 라우팅.
- **각 노드의 레벨 내용·난이도:** [`level-architect`](../wgf-level-architect/SKILL.md)에 위임(LD-* 곡선).
...
## 연계 / 라우팅
- **상위:** [`web-game-builder`](../wgf-web-game-builder/SKILL.md) 오케스트레이션의 진행 구조 설계 레인.
- **자매:** [`level-architect`](../wgf-level-architect/SKILL.md)(개별 레벨 내용·난이도) — 맵의 각 노드를 채운다.
- **빌드:** [`game-ui-hud`](../wgf-game-ui-hud/SKILL.md)(맵 화면·메뉴·HUD) · [`level-designer`](../wgf-level-designer/SKILL.md)
  (타일/보드 빌드) · [`juice-fx`](../wgf-juice-fx/SKILL.md)(해금·전진 연출) · [`chip-sound`](../wgf-chip-sound/SKILL.md).
- **레퍼런스:** 색인 [reference/map-design/INDEX.md](./reference/map-design/INDEX.md) · 원칙
  ...
  [map-interview.md](./reference/map-interview.md) · Phaser4 [INDEX](../wgf-web-game-builder/reference/phaser/INDEX.md).
