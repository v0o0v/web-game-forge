...
- 어떤 외부 에셋을 쓰더라도 `assets.json` 라이선스 게이트(`policy.allow`)를 통과해야 한다. 라이선스가 안전하면 외부 에셋을 적극 쓰고, 절차 생성도 동등한 옵션이다. 이 문서는 법률 자문이 아니다.
...
- **제작요소 스킬:** 레벨 빌드 메카닉(체크포인트·구덩이·스폰·zone 판정)은 [../../../wgf-level-designer/SKILL.md](../../../wgf-level-designer/SKILL.md)로 이어진다. 재미요소 태그(`FE-FLOW`/`FE-FAIRNESS`/`FE-JUST-ONE-MORE`/`FE-MASTERY` 등)는 [../../../wgf-web-game-builder/reference/game-dna/fun-elements.md](../../../wgf-web-game-builder/reference/game-dna/fun-elements.md), 게임 DNA 색인은 [../../../wgf-web-game-builder/reference/game-dna/INDEX.md](../../../wgf-web-game-builder/reference/game-dna/INDEX.md).
- **레벨 인터뷰:** 새 러너/엔드리스 레벨을 설계할 때 요구사항 크리스털라이징은 [../level-interview.md](../level-interview.md).
- **엔진/API:** seeded rng·객체 풀링·Arcade 점프 판정 구현은 [../../../wgf-web-game-builder/reference/engine-api.md](../../../wgf-web-game-builder/reference/engine-api.md)와 Phaser 4 레퍼런스 색인 [../../../wgf-web-game-builder/reference/phaser/INDEX.md](../../../wgf-web-game-builder/reference/phaser/INDEX.md)(특히 `physics-arcade.md`·`groups-and-containers.md`·`geometry-and-math.md`).
