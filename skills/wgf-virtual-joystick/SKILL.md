...
## Phaser 4 레퍼런스 라우팅
- 입력·포인터·멀티터치: [`reference/phaser/input.md`](../wgf-web-game-builder/reference/phaser/input.md)
- 씬 라이프사이클(update/shutdown 이벤트): [`reference/phaser/scenes.md`](../wgf-web-game-builder/reference/phaser/scenes.md)
- Graphics 렌더링(스틱 베이스/썸): [`reference/phaser/graphics-and-shapes.md`](../wgf-web-game-builder/reference/phaser/graphics-and-shapes.md)
...
- 공존: 디지털 입력은 [mobile-webview-tune](../wgf-mobile-webview-tune/SKILL.md)·[game-ui-hud](../wgf-game-ui-hud/SKILL.md)의 D-패드, 아날로그는 이 킷.
- 장르 연계: [topdown-shooter](../wgf-topdown-shooter/SKILL.md)(트윈스틱), [endless-runner](../wgf-endless-runner/SKILL.md)(가변 조향), [path-motion](../wgf-path-motion/SKILL.md)(탄막과 조합).
- IP-safe: 외부 에셋 0 — 스틱은 Graphics 로 그리고, 발사체는 절차 텍스처(PixelForge/VectorForge)와 함께 쓴다.
- 검증: [game-qa](../wgf-game-qa/SKILL.md) 헤드리스 step 하니스 + `joy.inject()`.
