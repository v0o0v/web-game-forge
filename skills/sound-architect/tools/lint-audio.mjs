...
//   node skills/sound-architect/tools/lint-audio.mjs --file games/<slug>/audio.json --json
//   node skills/sound-architect/tools/lint-audio.mjs <file> --strict   (warn 도 실패로)
//
