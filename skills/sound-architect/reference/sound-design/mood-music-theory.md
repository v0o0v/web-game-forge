...
> 관련: [synthesis-recipes.md](./synthesis-recipes.md) · [genre-timbres.md](./genre-timbres.md) · [adaptive-music.md](./adaptive-music.md) · [consistency-tools.md](./consistency-tools.md) · IP 보호 [ip-license-guard](../../../ip-license-guard/SKILL.md).
...
**연관:** `MOOD-SCALE-MAP` · `MOOD-ORIGINAL-MELODY` · [`ip-license-guard`](../../../ip-license-guard/SKILL.md)
...
**연관:** `MOOD-PROGRESSION` · `MOOD-SCALE-MAP` · [`ip-license-guard`](../../../ip-license-guard/SKILL.md) · [`consistency-tools.md §(g)cc0`](./consistency-tools.md)
