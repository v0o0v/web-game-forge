...
## 출처
- 실루엣 우선·chibi 비율·라인웨이트·아웃라인 처리(2D 캐릭터 아트·도트 통념)를 작은 웹게임·생성 도구 핸드오프용으로 정리. 실루엣 우선·작은 크기 진실은 [ability-design/presentation-ux.md](../../wgf-ability-architect/reference/ability-design/presentation-ux.md) `UX-SILHOUETTE-FIRST`·item-architect visual 슬롯과 정합.
