...
- **Lighting 컴포넌트** (`setLighting`, `setSelfShadow`) →
  [`reference/phaser/game-object-components.md`](../web-game-builder/reference/phaser/game-object-components.md) (Lighting 섹션)
- **Noise GO** (`noiseSimplex2D` 등), **Gradient GO**, **SpriteGPULayer** →
  [`reference/phaser/v4-new-features.md`](../web-game-builder/reference/phaser/v4-new-features.md) (New Game Objects 섹션)
...
- 엔진 API 전체 색인: [`reference/engine-api.md`](../web-game-builder/reference/engine-api.md).
- bloom 연계: [`skills/screen-fx/SKILL.md`](../screen-fx/SKILL.md) — PointLight + bloom 조합이 야경의 핵심.
- 경로 팔로워 + 점광원 조합(등불 패턴): [`skills/path-motion/SKILL.md`](../path-motion/SKILL.md).
- Phaser 4 새 기능(Noise, Gradient): [`reference/phaser/v4-new-features.md`](../web-game-builder/reference/phaser/v4-new-features.md).
