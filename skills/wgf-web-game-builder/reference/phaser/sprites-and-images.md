# Phaser 4 레퍼런스 — Sprites and Images

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/sprites-and-images`](https://github.com/phaserjs/phaser/tree/master/skills/sprites-and-images) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** Sprite, Image, this.add.sprite, this.add.image, texture, setTint, setAlpha.
...
**Related skills:** ./loading-assets.md, ./animations.md, ./physics-arcade.md, ./game-object-components.md
