# Phaser 4 레퍼런스 — Phaser v3 to v4 Migration Guide

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/v3-to-v4-migration`](https://github.com/phaserjs/phaser/tree/master/skills/v3-to-v4-migration) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** migrate, upgrade, v3 to v4, breaking changes, Phaser 3 to 4, migration guide, update from v3.
...
**Related skills:** ./v4-new-features.md, ./game-setup-and-config.md, ./filters-and-postfx.md
