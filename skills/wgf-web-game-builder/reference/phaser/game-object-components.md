# Phaser 4 레퍼런스 — Game Object Components
> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/game-object-components`](https://github.com/phaserjs/phaser) · MIT License.
> **대상 버전:** Phaser **4.1.0**.
> **이 문서를 읽어야 할 때:** component, mixin, transform, mask, bounds, lighting.
...
For RenderNodes, RenderSteps, and FilterList details, see the [filters-and-postfx skill](./filters-and-postfx.md) and [INDEX.md](./INDEX.md).
...
For a full component-to-game-object matrix, see [INDEX.md](./INDEX.md).
...
**Related skills**: `./sprites-and-images.md`, `./filters-and-postfx.md`
