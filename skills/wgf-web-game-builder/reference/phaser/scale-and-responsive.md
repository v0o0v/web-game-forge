# Phaser 4 레퍼런스 — Scale and Responsive Design

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/scale-and-responsive`](https://github.com/phaserjs/phaser/tree/master/skills/scale-and-responsive) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** ScaleManager, responsive, resize, fullscreen, FIT, scale mode.
...
**Related skills:** ./game-setup-and-config.md
