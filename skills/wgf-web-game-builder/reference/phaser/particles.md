# Phaser 4 레퍼런스 — Particle System

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/particles`](https://github.com/phaserjs/phaser/tree/master/skills/particles) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** particles, emitter, particle effect, explosion, fire, smoke.
...
**Related skills:** ./sprites-and-images.md, ./loading-assets.md
...
See `./INDEX.md` for the full source file map. Key entry points: `src/gameobjects/particles/ParticleEmitter.js` (main class), `src/gameobjects/particles/Particle.js` (individual particle), `src/gameobjects/particles/zones/` (zone classes).
