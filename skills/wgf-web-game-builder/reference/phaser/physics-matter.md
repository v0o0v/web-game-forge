# Phaser 4 레퍼런스 — Matter.js Physics

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/physics-matter`](https://github.com/phaserjs/phaser/tree/master/skills/physics-matter) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** Matter, matter physics, constraint, joint, rigid body, sensor.
...
**Related skills:** ./game-setup-and-config.md, ./sprites-and-images.md, ./physics-arcade.md, ./tilemaps.md
