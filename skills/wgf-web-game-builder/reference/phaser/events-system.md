# Phaser 4 레퍼런스 — Events System
> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/events-system`](https://github.com/phaserjs/phaser) · MIT License.
> **대상 버전:** Phaser **4.1.0**.
> **이 문서를 읽어야 할 때:** events, on, emit, EventEmitter, scene events, listeners.
...
**Related skills:** ./scenes.md, ./input-keyboard-mouse-touch.md
