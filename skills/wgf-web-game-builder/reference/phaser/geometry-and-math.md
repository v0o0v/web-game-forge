# Phaser 4 레퍼런스 — Geometry and Math
> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/geometry-and-math`](https://github.com/phaserjs/phaser) · MIT License.
> **대상 버전:** Phaser **4.1.0**.
> **이 문서를 읽어야 할 때:** Vector2, Rectangle, Circle, math, distance, angle, random, lerp.
