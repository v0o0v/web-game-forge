# Phaser 4 레퍼런스 — Text and BitmapText

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/text-and-bitmaptext`](https://github.com/phaserjs/phaser/tree/master/skills/text-and-bitmaptext) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** Text, BitmapText, this.add.text, font, word wrap, text style.
...
**Related skills:** ./loading-assets.md, ./sprites-and-images.md, ./game-object-components.md
