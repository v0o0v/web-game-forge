# Phaser 4 레퍼런스 — Render Textures and Dynamic Textures

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/render-textures`](https://github.com/phaserjs/phaser/tree/master/skills/render-textures) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** RenderTexture, DynamicTexture, snapshot, draw to texture, stamp.
...
**Related skills:** ./sprites-and-images.md, ./loading-assets.md, ./cameras.md
