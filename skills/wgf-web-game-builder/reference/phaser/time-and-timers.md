# Phaser 4 레퍼런스 — Time and Timers

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/time-and-timers`](https://github.com/phaserjs/phaser/tree/master/skills/time-and-timers) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** timer, delay, delayedCall, TimerEvent, Clock, time event.
...
**Related skills:** ./scenes.md, ./tweens.md
