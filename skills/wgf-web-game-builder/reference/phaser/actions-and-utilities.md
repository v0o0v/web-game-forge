# Phaser 4 레퍼런스 — Phaser 4 -- Actions & Utility Functions

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/actions-and-utilities`](https://github.com/phaserjs/phaser/tree/master/skills/actions-and-utilities) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** align, grid layout, actions, set operations on groups of game objects.
...
**Related skills:** ./groups-and-containers.md, ./sprites-and-images.md
