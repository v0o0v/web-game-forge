# Phaser 4 레퍼런스 — Graphics and Shapes
> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/graphics-and-shapes`](https://github.com/phaserjs/phaser) · MIT License.
> **대상 버전:** Phaser **4.1.0**.
> **이 문서를 읽어야 할 때:** Graphics, draw shape, fillRect, lineStyle, polygon, arc.
