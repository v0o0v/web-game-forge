# Phaser 4 레퍼런스 — Phaser 4 New Features

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/v4-new-features`](https://github.com/phaserjs/phaser/tree/master/skills/v4-new-features) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** new in v4, Phaser 4 features, RenderNode, SpriteGPULayer, CaptureFrame, Gradient game object, Noise game object, new tint modes.
...
**Related skills:** ./v3-to-v4-migration.md, ./filters-and-postfx.md, ./game-object-components.md, ./tilemaps.md

> **Migrating from v3?** See the [v3 to v4 Migration Guide](./v3-to-v4-migration.md) for step-by-step code changes, removed APIs, and a migration checklist.
...
For detailed configuration options, API reference tables, and source file maps, see [the reference guide](./INDEX.md).
