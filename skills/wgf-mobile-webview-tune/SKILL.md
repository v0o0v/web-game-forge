...
## 연계 / 원칙
- 상세 체크리스트: `skills/wgf-web-game-builder/reference/mobile-webview.md`
- MobileHarness API: `skills/wgf-web-game-builder/reference/engine-api.md`
- 예제 구현: `games/super-runner/` (TouchControls, onResume 실제 사용 사례)
- web-game-builder 워크플로의 품질 게이트. 모바일 배포 전 필수 통과.
- Phaser 4 API 참고: [scale-and-responsive](../wgf-web-game-builder/reference/phaser/scale-and-responsive.md), [game-setup-and-config](../wgf-web-game-builder/reference/phaser/game-setup-and-config.md), [input-keyboard-mouse-touch](../wgf-web-game-builder/reference/phaser/input-keyboard-mouse-touch.md). 전체 색인은 [reference/phaser/INDEX.md](../wgf-web-game-builder/reference/phaser/INDEX.md).
