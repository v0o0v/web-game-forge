...
이 파일은 WT-* 캐논 전체를 정의하는 1차 사전이다. 캐릭터(CH-*)·플롯/구조(ST-*)·대사(DL-*)·반전(TW-*) 등 형제 도메인은 같은 `reference/story-design/` 폴더의 다른 파일로 분기한다. 엔진 제약·API는 [../../../wgf-web-game-builder/reference/engine-api.md](../../../wgf-web-game-builder/reference/engine-api.md)와 [../../../wgf-web-game-builder/reference/phaser/INDEX.md](../../../wgf-web-game-builder/reference/phaser/INDEX.md).
