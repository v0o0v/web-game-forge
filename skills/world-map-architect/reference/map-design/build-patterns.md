...
> 그대로 따른다. Phaser 4 API는 [reference/phaser/INDEX.md](../../../web-game-builder/reference/phaser/INDEX.md)
...
- [ ] 각 노드의 레벨 내용·난이도는 [`level-architect`](../../../level-architect/SKILL.md)에 위임했는가
