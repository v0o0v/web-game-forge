...
> 개별 레벨 내용·난이도는 [`level-architect`](../../../level-architect/SKILL.md)(LD-*), 재미요소 조합은
> [game-dna/fun-elements.md](../../../web-game-builder/reference/game-dna/fun-elements.md)(FE-*) 참고.
...
- **IP 안전 원칙:** 맵디자인 *원칙·기법·위상*은 저작권 보호 대상이 아니므로 자유롭게 차용한다. 단, 특정 상용
  ...
  기법만 가져와 절차생성/오리지널 배치로 재구성한다. 상세는 [`ip-license-guard`](../../../ip-license-guard/SKILL.md).
