...
> 능력이 캐릭터·서사·코어 동사와 같은 말을 할 때 몰입한다. 인터뷰 A9. 톤·이름은 [`story-architect`](../../../story-architect/SKILL.md) STORY.md 상속.
...
모든 능력 이름·flavor가 한 목소리(STORY.md 톤)를 공유한다 — 진지한 게임엔 진지한 이름, 코믹엔 코믹. 한 능력만 톤이 튀면 몰입이 깨진다. flavor는 [`story-architect`](../../../story-architect/SKILL.md)와 정합.
