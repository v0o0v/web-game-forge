...
Phaser 4 레퍼런스 전체: [physics-matter.md](../wgf-web-game-builder/reference/phaser/physics-matter.md).
엔진 API 색인: [reference/engine-api.md](../wgf-web-game-builder/reference/engine-api.md).
충돌·쌓기 외 포스트FX 연출: [juice-fx](../wgf-juice-fx/SKILL.md).
