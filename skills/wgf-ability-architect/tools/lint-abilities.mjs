...
//   node skills/wgf-ability-architect/tools/lint-abilities.mjs --file <path> --json
//   node skills/wgf-ability-architect/tools/lint-abilities.mjs <file> --strict   (warn 도 실패로)
//
