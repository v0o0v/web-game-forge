 ...
 *   node skills/wgf-sprite-picker/catalog/prefetch.mjs --only kenney
 *   node skills/wgf-sprite-picker/catalog/prefetch.mjs --limit 8  # 대표 subset 만
 *   node skills/wgf-sprite-picker/catalog/prefetch.mjs --force    # 이미 받은 것도 다시
