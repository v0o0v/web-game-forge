...
스킬이 매번 웹을 뒤지지 않게 한다.** 카탈로그 갱신은 [`sprite-catalog-refresh`](../../wgf-sprite-catalog-refresh/SKILL.md)
...
- **`preview`** 는 [`sprite-catalog-refresh`](../../wgf-sprite-catalog-refresh/SKILL.md) 의 `catalog/prefetch.mjs`
