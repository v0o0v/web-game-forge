...
- **연관:** `AFX-ROLL-WEIGHTED`, `AFX-PREFIX-SUFFIX`, [economy-loot.md](./economy-loot.md)의 `ECON-CURVE`·`ECON-REWARD-PACING`, [level-architect](../../../wgf-level-architect/SKILL.md).
...
- **연관:** `AFX-RARITY-MEANS-MORE`, `AFX-VISUAL-DIFF`, [identity-narrative.md](./identity-narrative.md)의 `IDENT-LUDO-HARMONY`, [story-architect](../../../wgf-story-architect/SKILL.md).
...
- **연관:** `AFX-RARITY-LADDER`, `AFX-LEGENDARY`, [visual-inventory-ux.md](./visual-inventory-ux.md)의 `UX-RARITY-MULTI-CHANNEL`, [juice-fx](../../../wgf-juice-fx/SKILL.md)·[chip-sound](../../../wgf-chip-sound/SKILL.md).
