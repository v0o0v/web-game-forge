# Phaser 4 레퍼런스 — Scenes

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/scenes`](https://github.com/phaserjs/phaser/tree/master/skills/scenes) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** Scene, scene lifecycle, preload, create, update, scene transition, SceneManager.
...
**Related skills:** ./game-setup-and-config.md, ./loading-assets.md, ./events-system.md
...
For detailed API reference tables and source file maps, see [INDEX.md](./INDEX.md).
