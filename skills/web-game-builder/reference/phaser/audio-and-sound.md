# Phaser 4 레퍼런스 — Audio and Sound

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/audio-and-sound`](https://github.com/phaserjs/phaser/tree/master/skills/audio-and-sound) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** sound, audio, music, volume, mute.
...
**Related skills:** ./loading-assets.md, ./game-setup-and-config.md
