# Phaser 4 레퍼런스 — Arcade Physics

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/physics-arcade`](https://github.com/phaserjs/phaser/tree/master/skills/physics-arcade) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** physics, arcade, velocity, gravity, collide, overlap, bounce, physics body.
...
**Related skills:** ./game-setup-and-config.md, ./sprites-and-images.md, ./tilemaps.md, ./groups-and-containers.md
