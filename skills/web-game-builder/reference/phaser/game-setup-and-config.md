# Phaser 4 레퍼런스 — Game Setup and Config
> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/game-setup-and-config`](https://github.com/phaserjs/phaser) · MIT License.
> **대상 버전:** Phaser **4.1.0**.
> **이 문서를 읽어야 할 때:** new Phaser.Game, GameConfig, game setup, renderer, pixel art, FPS.
...
**Related skills:** ./scenes.md, ./loading-assets.md, ./scale-and-responsive.md
