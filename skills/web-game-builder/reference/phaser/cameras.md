# Phaser 4 레퍼런스 — Cameras

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/cameras`](https://github.com/phaserjs/phaser/tree/master/skills/cameras) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** camera, viewport, scroll, zoom, follow, shake, fade.
...
**Related skills:** ./game-setup-and-config.md, ./sprites-and-images.md, ./filters-and-postfx.md
