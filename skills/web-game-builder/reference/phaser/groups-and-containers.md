# Phaser 4 레퍼런스 — Groups and Containers
> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/groups-and-containers`](https://github.com/phaserjs/phaser) · MIT License.
> **대상 버전:** Phaser **4.1.0**.
> **이 문서를 읽어야 할 때:** Group, Container, object pool, getFirstDead, children.
...
**Related skills:** ./sprites-and-images.md, ./physics-arcade.md
