# Phaser 4 레퍼런스 — Filters and Post-FX
> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/filters-and-postfx`](https://github.com/phaserjs/phaser) · MIT License.
> **대상 버전:** Phaser **4.1.0**.
> **이 문서를 읽어야 할 때:** filter, post-processing, shader, bloom, blur, glow, color effects.
