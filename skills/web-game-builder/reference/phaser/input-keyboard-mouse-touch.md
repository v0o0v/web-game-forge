# Phaser 4 레퍼런스 — Input: Keyboard, Mouse, Touch, and Gamepad
> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/input-keyboard-mouse-touch`](https://github.com/phaserjs/phaser) · MIT License.
> **대상 버전:** Phaser **4.1.0**.
> **이 문서를 읽어야 할 때:** keyboard, mouse, touch, pointer, drag, drop, click, input, gamepad, cursor keys.
> **한글 라우팅·요약:** [INDEX.md](./INDEX.md)
> ⚠ 아래 본문은 Phaser 공식 영문 레퍼런스를 그대로 벤더링한 것이다. 번역하지 않는다.
---
...
**Related skills:** ./sprites-and-images.md, ./events-system.md, ./scenes.md
...
Pointer events fire at three levels (see [INDEX.md](./INDEX.md) for details):
...
For detailed configuration options, API reference tables, and source file maps, see [INDEX.md](./INDEX.md).
