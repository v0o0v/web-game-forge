# Phaser 4 레퍼런스 — Curves and Paths

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/curves-and-paths`](https://github.com/phaserjs/phaser/tree/master/skills/curves-and-paths) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** curve, path, spline, bezier, path follower.
...
**Related skills:** ./sprites-and-images.md, ./graphics-and-shapes.md, ./tweens.md
