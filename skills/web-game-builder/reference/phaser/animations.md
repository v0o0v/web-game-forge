# Phaser 4 레퍼런스 — Phaser 4 -- Sprite Animations

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/animations`](https://github.com/phaserjs/phaser/tree/master/skills/animations) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** sprite animation, spritesheet, play animation, animation frames.
