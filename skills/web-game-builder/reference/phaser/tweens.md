# Phaser 4 레퍼런스 — Tweens

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/tweens`](https://github.com/phaserjs/phaser/tree/master/skills/tweens) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** tween, ease, animate, this.tweens.add, tween chain, stagger.
...
**Related skills:** ./sprites-and-images.md, ./animations.md
