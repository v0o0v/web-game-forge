# Phaser 4 레퍼런스 — DataManager

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/data-manager`](https://github.com/phaserjs/phaser/tree/master/skills/data-manager) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** setData, getData, data events, custom data storage.
...
**Related skills:** ./scenes.md, ./events-system.md
