# Phaser 4 레퍼런스 — Tilemaps

> **출처:** Phaser 공식 스킬 [`phaserjs/phaser/skills/tilemaps`](https://github.com/phaserjs/phaser/tree/master/skills/tilemaps) · MIT License.
> **대상 버전:** 본 플러그인 `engine/phaser.min.js` = **Phaser 4.1.0**.
> **이 문서를 읽어야 할 때:** Tilemap, Tiled, tilemap layer, tile collision, tile properties.
...
**Related skills:** ./loading-assets.md, ./sprites-and-images.md
