...
- 레지스트리: [`library.json`](./library.json) — 스키마는
  [skills/wgf-sprite-picker/reference/catalog-schema.md](../skills/wgf-sprite-picker/reference/catalog-schema.md) §3.
- 항목별 폴더 `<item-id>/` 에 `sheet.png`(+`sheet.json` 아틀라스, `thumb.png`)를 벤더링.
- 운영·재사용 흐름: [skills/wgf-sprite-picker/reference/library.md](../skills/wgf-sprite-picker/reference/library.md).
